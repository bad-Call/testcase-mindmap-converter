...
import {  jsonToCaseNode as parseJsonCase  } from '../../../json_modules/json_case.js';
import { caseNodeToJson as renderJsonCase } from '../../../json_modules/json_case.js';
import type {  RawJsonNode } from '../../../types/jsonNode_types.js';
...
describe('json_case - 端到端用例', () => {
  it('应能把 RawJsonCase 解析成 CaseNode', () => {
    ...
    expect(node.title).toBe('客户端边界场景 - 安卓设备未安装App，点击短链跳转浏览器');
